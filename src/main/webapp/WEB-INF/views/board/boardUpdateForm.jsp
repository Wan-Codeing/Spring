...
<body>
	...
	<div class="content">
		...
		<div class="innerOuter">
			...
			<form action="${contextPath}/board/update/${boardCode}/${boardNo}" id="enrollForm" enctype="multipart/form-data" method="post">
				<table align="center">
					...
					<c:forEach var="at" items="${board.attachList}">
						...
						<tr>
		                  ...
		                  <span class="delete-image" style="cursor:pointer;">&times;</span>
		                  </td>
		               </tr>
		               <tr>
					...
					<tr>
						<th>내용</th>
						<td>
							<textarea id="content" style="resize:none;" rows="10" class="form-control" name="boardContent" required>${board.boardContent}</textarea>
						</td>
					</tr>
				</table>
				<div align="center">
				...
				<%-- 
					존재하고있던 이미지가 제거되었음을 기록하는 input태그
	...
	<script>
		...
		const deleteSet = new Set(); // 키값 중복 X , 순서 상관없음
		...
		for(let i=0 ; i<inputImage.length ; i++){
		    ...
		    deleteImage[i].addEventListener("click", function(){
		        ...
		        if( preview[i].getAttribute("src")  !=  "" ){
		            ...
		            // Array.from(유사배열 | 컬렉션) : 매개변수에들어간 객체를 배열로 변환해서 반환
