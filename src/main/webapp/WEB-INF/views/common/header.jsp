...
<style>
	...
	#header_2 li:hover {background-color: lightgray; cursor:pointer;}
...
<body>
	...
	<div id="header">
		...
		<div id="header_2">
			<ul>
				<li><a href="${contextPath}" data-aos="fade-up" data-aos-delay="250">HOME</a></li>
				<li><a href="${contextPath}/chat/chatRoomList" data-aos="fade-up" data-aos-delay="350">채팅</a></li>
				<c:forEach items="${boardTypeList}" var="boardType">
					<li><a href="${contextPath}/board/list/${boardType.boardCd}" data-aos="fade-up" data-aos-delay="450">${boardType.boardName}</a></li>
				</c:forEach>
			</ul>
		</div>
	</div>
